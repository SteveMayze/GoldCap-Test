...
#define EXAMPLE_CODE SINGLE_CONVERSION // WINDOW_COMPARATOR_MODE

#define MAX_VOL 1.1 // VREF=2.5V
#define RES_10BIT 0x3FF
#define ADC_CHANNEL 0x1E
...
void read_adc_single_conversion()
{
	...
	uint32_t temp = adc_result - sigrow_offset;
	temp *= sigrow_gain;  // Result might overflow 16 bit variable (10bit+8bit)
	temp += 0x80;               // Add 1/2 to get correct rounding on division below
	temp >>= 8;                 // Divide result to get Kelvin
	calc_volt = temp -273.15;
